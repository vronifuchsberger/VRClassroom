      ...
      <View>
        <View style={styles.row}>
          ...
          <KeyboardButton
            ...
            keyboardColor={this.props.keyboardColor}
            value="Delete"
            clickHandler={this.handleDelete.bind(this)}
            isDisabled={false}
          />
        </View>
        <View style={styles.row}>
          {layoutArray[0].map(value => (
            <KeyboardButton
              keyboardOnHover={this.props.keyboardOnHover}
              keyboardColor={this.props.keyboardColor}
              key={value}
        ...
        <View style={styles.row}>
          <KeyboardButton
            ...
            keyboardColor={this.props.keyboardColor}
            value="Shift"
            clickHandler={this.handleShift.bind(this)}
            isDisabled={this.state.isSymbolSelected}
          />
          {layoutArray[2].map(value => (
            <KeyboardButton
              keyboardOnHover={this.props.keyboardOnHover}
              keyboardColor={this.props.keyboardColor}
              key={value}
          ...
          <KeyboardButton
            ...
            value={
              this.state.isSymbolSelected
                ? layout.alphabet.displayValue
                : layout.symbol.displayValue
            }
            clickHandler={this.handleSymbolSelector.bind(this)}
            isDisabled={false}
          />
        </View>
        <View style={styles.row}>
