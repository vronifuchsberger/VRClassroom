...
\section{Einleitung}
Mit den fallenden Preisen für Endgeräte wird Virtual Reality für immer mehr Menschen zugänglich. Dadurch ergeben sich immer mehr neue Möglichkeiten VR-Anwendungen sinnvoll in den Alltag zu integrieren.
Eines dieser Felder ist die Nutzung von Virtual Reality im Schulunterricht: Die Stand-alone Headsets erlauben es, eine gesamte Klasse mit Geräten auszustatten, mit denen die Schülerinnen und Schüler dann VR-Inhalte erkunden und so auf eine neue Art lernen können.
...
Virtual Reality kurz VR bezeichnet eine virtuelle Welt, die dem Nutzer präsentiert wird, in der er interagieren und die Gegenstände um sich herum erforschen kann. Die virtuelle Welt ist dabei komplett unabhängig von der physischen Welt um den Nutzer. VR versucht dabei ein Möglichst großes Gefühl der Präsenz in der gezeigten Welt zu erzeugen. \cite{Stone2017}
...
In dieser Arbeit beschäftigten sich die Forscher mit einem Lernsystem für Bauingenieur Studenten. Dabei konnten diese sich innerhalb der VR-Anwendung in einem Haus bewegen, das in jedem Raum einen anderen Lerninhalt präsentierte. 
...
Abschließend wird ein Blick in die Zukunft von Virtual Reality im Allgemeinden und von VRClassroom im Speziellen geworfen. Dabei wird sowohl auf aktuell bestehende Probleme, als auf potentielle Weiterentwicklungen der Software eingegangen.
...
\section{Ausblick}
%TODO
Allen Prognosen nach wird Rolle von VR (Quelle dazu?) in den kommenden Jahren weiter wachsen, von Ausbildung, Beruf bis zur Freizeit, wird es immer mehr VR-Geräte und auch Anwendungen geben. 
