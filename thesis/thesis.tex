...
Ein VR-System ist ein Gerät, dass VR-Inhalte anzeigen kann. Das können zum Einen so genannte Head-mounted Displays (HMD), auch bekannt als VR-Brillen oder VR-Headsets, sein oder eine CAVE. Eine CAVE ist ein Raum, bei dem alle Seiten Displays sind, die virtuelle Inhalte anzeigen. In beiden Fällen können Nutzer mit dem VR-System interagieren.
...
In der folgenden Arbeit werden zu Beginn die verschiedenen Virtual Reality Headsets, die momentan auf dem Markt sind, aufgeführt und anhand verschiedener Merkmale verglichen. Dabei werden sowohl die High-End Produkte als auch die günstigen Einsteiger-Geräte besprochen.
...
In Kapitel sechs wird auf das im Rahmen dieser Arbeit entwickelte VRClassroom eingegangen. Zuerst wird das Anwendungszenario und die zukünftige Nutzergruppe festgestellt und welche Anforderungen sich dadurch für VRClassroom ergeben. Daraufhin wird auf die Struktur des zweiteiligen Systems und die einzelnen Funktionen und deren Implementation eingegangen.
...
Der große Vorteil von WebVR gegenüber nativer Apps ist, dass keine App vor der Nutzung installiert werden muss. Außerdem muss dafür auch nicht für alle Zielplattformen ein extra Binary erzeugt werden. Den klaren Vorteil der besseren Performance nativer Apps nutzt die VRClassroom ohnehin nicht aus, da es sich nicht um ein grafisch aufwändiges Spiel handelt, sondern die Anzeige weniger komplexerer 3D-Modelle sowie 360°-Fotos und -Videos.
Die Schüler-App von VRClassroom sollte daher als WebVR-Anwendung realisiert werden.

React360 und A-Frame sind beides Frameworks, die die Ansprüche für die Schüler-App vom VRClassroom erfüllen. 
Die Entscheidung für React360 fiel letztendlich deswegen, da dadurch sowohl die Lehrer-App, als auch die Schüler-App beide mit React.js geschrieben werden konnten.
Bis auf kleine Syntax-Unterschiede sind React360 und React.js gleich aufgebaut. 
