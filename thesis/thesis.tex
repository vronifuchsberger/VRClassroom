...
\section{Einleitung}
VR-Headsets immer mehr verbreitet, es gibt immer mehr Content
...
%http://personales.upv.es/mjuanli/docs/HumanBody.pdf

%https://ir.nctu.edu.tw/bitstream/11536/828/1/A1997YD93400001.pdf

%http://sro.sussex.ac.uk/2170/1/Luckin2006Making163.pdf
% viruteller Spiegel, Kinder fanden normal besser

%https://ac.els-cdn.com/S1877050915036960/1-s2.0-S1877050915036960-main.pdf?_tid=da5cab22-307e-449c-b518-0ab5b814c965&acdnat=1548721967_676b83ce785214aa2130273e4765f087
% auch was zum Gewicht von HMDs?
% immer feste Inhalte, keine freie Software für eigene Inhalte

%https://www.researchgate.net/profile/Laura_Freina/publication/280566372_A_Literature_Review_on_Immersive_Virtual_Reality_in_Education_State_Of_The_Art_and_Perspectives/links/55ba24b208ae9289a0926382.pdf
% literature review

Viele ältere paper nennen VR, auch wenn nicht in VR-System.
Kaum Arbeiten, die in Schulen stattfinden ( insgesamt oft nur einzelne Testpersonen gleichzeitig)

%http://www.gkatsion.kman.gr/2008/ComputersAndEducation-Journal/Computers&Education_2008_VirvouKatsionis.pdf
% Geographie-Spiel für Schüler
% Studie dazu, ob sinnvoll und gerne genutzt

%http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.494.3756&rep=rep1&type=pdf
% AR Headset, Studie zu Kollaboration damit. Mal sehen ob das sinnnvoll ist


\subsection{Aufbau der Arbeit}
In dieser Arbeit werden zu Beginn die verschiedenen Virtual Reality Headsets, die momentan auf dem Markt sind, aufgeführt und anhand verschiedener Merkmale verglichen. Dabei werden sowohl die High-End-Produkte als auch die günstigen Einsteiger-Geräte besprochen.
...
Im folgenden Kapitel werden die Herausforderungen behandelt, die Virtual Reality Systeme aktuelle noch haben. Außerdem wird auf das Mindestalter zur Nutzung von VR-Systemen eingegangen. Interessanterweise sehen Forscher Virtual Reality als eine vielseitige Möglichkeit besonders in der Forschung und Therapie von Kindern, während die Hersteller von kommerziellen VR-Headsets Kinder von der Nutzung ausschließen.

Das fünfte Kapitel beschäftigt sich mit den verschiedenen Inhaltstypen, die in VR-Systemen genutzt werden können. Dabei wird sowohl auf die unterschiedlichen Projektionen von 360° Bildmaterial, 360°-Foto und -Videos, 3D-Modelle, 3D Audio und VR-Anwendungen eingegangen. Da das Softwareprojekt VRClassroom React360 nutzt wird zudem besprochen wie die Inhalte in React360 genutzt werden können.

Anschließend werden die verschiedenen Möglichkeiten der Software-Entwicklung für VR-Anwendungen besprochen. Sie unterscheiden sich in native VR-Applikationen und Webbasierte VR-Anwendungen. Zudem wird die Entschlussfindung erläutert, warum sich für die Entwicklung mit React360 entschieden wurde.

In Kapitel 6 wird auf das im Rahmen dieser Arbeit entwickelte Software VRClassroom eingegangen. Zuerst wird das Anwendungsszenario und die zukünftige Nutzergruppe definiert und welche Anforderungen sich dadurch für VRClassroom ergeben. Daraufhin wird auf die Struktur des zweiteiligen Systems, die einzelnen Funktionen und deren Implementation eingegangen.

Im Anschluss an die Entwicklung wurde VRClassroom mit einer Umfrage unter Lehrkräften evaluiert. Die Fragen beinhalten sowohl die Bewertung von VRClassroom und seinen Funktionen, als auch die Einschätzung der Teilnehmer zu Virtual Reality im Unterricht und die eigene Bereitschaft VR-Programme einzusetzen.
Die Mehrheit der Befragten zeigte sich dabei interessiert daran VR-Anwendungen im eigenen Unterricht zu nutzen und können sich vorstellen VRClassroom zu verwenden.

Der Schluss beschäftigt sich mit der Zukunft von Virtual Reality und der möglichen Zukunft von VRClassroom. Dabei wird sowohl auf aktuell bestehende Probleme, als auf potentielle Weiterentwicklungen der Software eingegangen.
%______________________________________________________________________
...
Bei 6 DoF-Controllern, wird deren Position im Raum durch Positional-Tracking-Systeme bestimmt. Anders als bei 3DoF-Controllern, ist damit die Position des Controllers nicht fixiert, sondern kann im Raum verändert werden.
...
Trotzdem wird von Experten erwartet, dass die Preise für VR-System weiter sinken werden, sodass auch die hochwertigen Lösungen erschwinglicher für alle Nutzergruppen werden. %TODO Quelle
...
Merchant et al. schließen in ihrer Arbeit in 2014, dass Lernen mit Virtual Reality bessere Lernergebnisse produziert als Lernen ohne VR. Sie sehen damit die finanzielle und zeitliche Investition der Einführung von VR-Systemen als sinnvoll an.
...
Hier noch die Beispiele einfügen %TODO
...
Hinzu kommt der Abo-Preis von 299£ für das ClassVR Portal, mit dem die Geräte gesteuert und Inhalte ausgewählt werden können.
...
Die Kommunikation zwischen dem Rechner der Lehrkraft und den ClassVR-Headsets läuft über das Internet. Damit die großen Datenmengen der 360°-Inhalte übertragen werden können müssen sowohl das lokale WLAN als auch die Internetverbindung der Schule entsprechend ausgelegt sein.
...
Momentan gibt es mehr als 900 verschiedene Expeditionen, die kostenlos genutzt werden können. Zudem können auch selbst Touren erstellt werden.
...
Sie ist keine App, die speziell für die Nutzung in der Schule entwickelt wurde. Die verfügbaren Inhalte bieten sich aber für den Einsatz im Unterricht an. Die Videos haben dabei entweder eine englische Audiospur oder sind ohne Erzählstimme.


\subsubsection{Unimersiv}
Unimersiv ist eine App, die es für GearVR und Oculus Rift gibt. Innerhalb der App können unterschiedliche VR-Anwedungen genutzt werden. Beispielsweise kann die internationale Raumstation (ISS) erkundet werden. Im Moment sind neun verschiedene VR-Anwendungen auf der Plattform vorhanden. Schulen können für einmalig 49\$ pro Headset eine Lizenz erwerben, in der alle verfügbaren Inhalte enthalten sind und auch alle neuen Entwicklungen kostenlos geladen werden können.

Außerdem werden auch Simulations-Anwendungen für Unternehmen angeboten. Eine dieser Apps erlaubt es beispielsweise den Mitarbeitern einer Firma die Steuerung von Staplern in einem sicheren Rahmen zu erlernen.
% https://unimersiv.com


%_______________________________________________________________________________________________________________________
\cleardoublepage % Neue rechte Seite anfangen
\section{Herausforderungen bei VR-Systemen}
...
Besonders bei Simulator-Trainings wird bereits seit längerer Zeit auf VR gesetzt (QUELLE), diese sind aber meist nicht auf konventionellen VR-Headsets nutzbar. Eine neuere Applikation für VR in der Bildung sind Google Expeditions, wie in \ref{sec:VReducation} genauer erläutert. %TODO
...
Oculus weist konkret darauf hin, dass eine Nutzung ihrer Geräte unter 13 Jahren ihren Nutzungsbedingungen widerspricht. ``The Services are intended solely for users who are aged 13 or older. Any registration for, or use of, the Services by anyone under the age of 13 is unauthorised, unlicensed and in breach of these Terms.'' Es werden allerdings keine genauen Gründe für diese Altersrestriktion angegeben.
...
Bei der equirectangularen Projektion werden die Gradzahlen von Längen- und Breitengrade auf die x und y-Werte in einem Gitternetz projiziert. Ein Bildpunkt an (53°/ 90°) wird dann im projizierten Bild an (53,100) dargestellt. Es wird keine zusätzliche Skalierung oder Transformation vorgenommen.
...
Vertikale Linien bleiben unverzerrt erhalten, horizontale Linien werden bis auf den Äquator immer verzerrrt dargestellt. Dadurch bleiben zudem keine Winkel erhalten.
...
Trotz diesen Nachteilen ist die equirectangulare Projektion die am weitesten verbreitete Projektion in der 360°-Szene.
...
Grafik \ref{fig:projection-equirectengular}
...
Grafik \ref{fig:projection-cylindric}
...
Grafik \ref{fig:projection-mercator}
...
Die Rectilinear-Projektion ist anders als die vorigen Projektionen keine zylindrische Projektion. Sie lässt sich verbildlichen indem man eine Kugel auf eine Fläche legt und einen Teil der Kugel vom Mittelpunkt der Kugel auf die Ebene projiziert. Ein einzelnes rectilienares Bild stellt also kein komplettes 360°-Panorama dar. Um ein komplettes Panorama zu erhalten werden dann einfach mehrere rectilineare Projektionen zusammen gesetzt.

Ein großer Vorteil dieser Projektion liegt darin, dass gerade Linien erhalten bleiben. Eine starke Verzerrung in dieser Projektion ist in den Ecken des Bildes zu finden und wird umso stärker, je weiter das Field of View ist. Will man ein möglichst unverzerrtes Panorama, sollten mehrere rectilienare Bilder mit einem kleineren Field of View zusammengesetzt werden.

Bekannt unter dem Begriff Cubemap-Projektion oder Skybox aus der Gaming-Szene ist die Kombination von sechs rectilinearer Bilder, die wie die Seiten eines Würfels angeordnet sind. Ein bekanntes Beispiel, bei dem Cubemap-Bilder verwendet werden, sind die Google StreetView-Panoramas. 

Grafik \ref{fig:projection-cubemap}
...
Grafik \ref{fig:projection-stereographic}
...
Grafik \ref{fig:projection-pannini}
...
Die wahrscheinlich bekanntesten Anwendungen, die 360°-Bilder anzeigen sind Google StreetView und 360°-Fotos auf Facebook, die der Nutzer einfach durch bewegen des Smartphones erkunden kann.
% TODO (Quellen!)
...
Eine weitere Möglichkeit an 360°-Fotos zu kommen, die größtenteils ebenfalls von Hobby-Fotografen stammen, ist die Google Photo Sphere Community, eine Gruppe auf Google Plus. Allerdings ist hier der Download nicht immer erlaubt und die Rechte für die Bilder auch nicht immer angegeben.
...
Airpano bietet speziell Bilder von Orten auf der Welt an wie zum Beispiel Städten oder geschichtlichen Orten aus der Luftperspektive an. Die Lizenzierung dieser Bilder ist mit ca. 1000 Euro pro Jahr teuer, sodass die Nutzung im Unterricht schwierig ist.
...
Die großen Videoplattformen Vimeo und YouTube haben seit einigen Jahren die Funktion 360°-Videos abzuspielen und bieten auch Möglichkeiten die Filme in VR-Headsets zu sehen. Widmer kritisiert hier allerdings die Qualität der Filme und die Tatsache, dass oft nur Stereo-Sound in dem Filme verwendet wird.
...
Die BBC hat eine App veröffentlicht, die exklusiv VR-Inhalte für ihre Leser bereitstellt und speziell für die Nutzung mit dem Google Cardboard entwickelt wurde. Darin zeigen sie von gefilmten 360°-Reportage bis hin zu 360°-Animationsfilmen Geschichten, die speziell für das 360°-Medium entwickelt wurden.
...
Eine schöne Quelle deutschsprachiger 360°-Videos gibt es vom ZDF, leider sind diese allerdings ebenfalls nicht zum Herunterladen, sondern nur über die ZDF VR-App, die es für Android, iOS und GearVR gibt, oder im Browser anschaubar ist.
% https://vr.zdf.de

Lizenzierbare 360°-Videos gibt es wie auch Fotos bei 360cities und Airpano. Diese sind aber eher gedacht um in Filme eingebaut zu werden, als einzeln verwendet zu werden. Sie sind vergleichbar zu Archivaufnahmen und damit meist nicht im Bildungsbereich sinnvoll verwendbar.
...
Das transform domain-based spatial audio wird auch als Ambisonics bezeichnet und beruht auf den zuvor beschriebenen Lage der Tonquellen. Da die Richtungen nicht direkt in Kanälen abgespeichert werden wie beim Channel-basierten spatial audio, kann auch hier ein variables Abspielsystem verwendet werden.
...
Neben der Anwendungsentwicklung können mit Unity auch 360°-Filme produziert werden. Dazu können 360°-Clips hineingeladen werden, Overlays, Objekte oder Animationen eingefügt werden und sogar Logik für Nutzerinteraktion eingebunden werden. Unity unterstützt dafür auch die Nutzung von Ambisonic Audioquellen.
% unity3d.com

\subsubsection{Unreal Engine}
\label{subsec:unreal}
Ebenso wie Unity ist die Unreal Engine für die Entwicklung von Computer und Konsolenspielen entwickelt worden. Der Unreal Editor ist für Linux, MacOS und Windows verfügbar und die enwickelten Anwendungen können zu Windows PC, PlayStation 4, Xbox One, Mac OS X, iOS, Android, AR, VR, Linux, SteamOS, Nintendo Switch und HTML5 deployed werden.
...
% Quelle: https://immersive-web.github.io/webvr/spec/1.1/

WebVR ist eine API, die es ermöglicht VR-Geräte und deren Sensoren über Webapps zu verwenden.
Die ursprüngliche WebVR API wird zukünftig durch die WebXR API ersetzt werden, die neben Virtual Reality-Geräten auch Augmented Reality- und Mixed Reality-Geräte unterstützt.
...
Die WebVR-API ist in folgenden Browsern unterstützt:
\begin{itemize}
...
% Quelle: https://caniuse.com/#feat=webvr

In Browsern, die die WebVR-API nicht implementieren, kann die Unterstützung mit einem sogenannten Polyfill nachgerüstet werden. Ein Polyfill ist ein JavaScript, das von einer Webseite ausgeführt wird um fehlende APIs in Browsern dynamisch nachzurüsten. Dabei ahmen Polyfills die Funktion der API nach, damit sich der Browser so verhält, als wäre die API verfügbar. Oft haben Polyfills dadurch eine schlechtere Performance als die native Implementierung der Browserhersteller. Für WebVR gibt es ein offizielles Polyfill der Immersive Web Working Group des W3Cs, die auch für die Entwicklung des Standards zuständig ist. In Browsern, die die WebVR-API bereits unterstützen, wird das Polyfill ignoriert und die native Implementierung verwendet.
% Quelle: https://github.com/immersive-web/webvr-polyfill
...
% TODO: das ist einfach nur das gleiche wie im Absatz drüber "Anwender", ich würde es einfach weglassen
...
Wie in Grafik \ref{fig:controls} zu sehen sind die Bedienelemente, mit denen Aktionen des aktuell geladenen Inhalts ausgelöst werden können durch einen Overlay über dem iFrame der React360-App dargestellt. 
...
% TODO: Grafik Kommunikation
Wie in Grafik XXX zu erkennen kommunizieren die Lehrer-App und die Schüler-App über eine WebSocket-Verbindung. Beim Start der VRClassroom-App auf dem Computer der Lehrkraft werden sowohl ein WebSocket-Server als auch ein HTTP-Server (Asset-Server) gestartet. Der HTTP-Server liefert die Inhalte so wie die Schüler-App selbst aus. Der WebSocket-Server wird zur Echtzeit-Kommuniktion zwischen Lehrer- und Schüler-App verwendet.
...
% TODO Code snippet vom State einfügen, dann brauchst du auch die Felder nich einzeln auflisten
...
Um das entwickelte VRClassroom-System zu evaluieren wurden zwei verschiedene Umfragen geplant. Eine qunatitative Online-Befragung, bei der die Teilnehmer ein Video ansehen und anschließend Fragen beantworten, und eine qualitative Feldstudie, bei der Lehrkräfte VRClassroom mit ihrer Klasse ausprobieren und im Anschluss Feedback geben.
...
Die Fragen wurden als Aussagen formuliert, zu denen mit Hilfe einer unzentrierten Lickert-Skala die Zustimmung zur jeweiligen Aussage angegeben werden konnte. Es wurde eine unzentrierte Skala verwendet um zu aussagekräftigeren Antworten zu ermuntern.

Insgesamt haben 59 Personen an der Umfrage teilgenommen, allerdings wurden nicht alle Fragen von allen Teilnehmer beantwortet, da die Beantwortung der einzelnen Fragen optional war. Die Prozentangaben aus den Grafiken beziehen sich dabei immer auf die abgegebenen Antworten für die jeweilige Frage.
...
Zudem wurde kritisiert, dass Google Cardboards nicht mit einer Brille genutzt werden können. Einige standalone-Headsets ermöglichen die Nutzung für Brillenträger, wie oben beschrieben. Diese Limitierung ist eine Hardware-Limitierung lässt sich softwareseitig in VRClassroom nicht lösen.
...
Wie Grafik \ref{fig:survey3} zu zeigt, korrelieren die Einschätzungen zu Markern auf den unterschiedlichen Medientypen mit den Meinungen zu den Medientypen selbst: 82\% stuften Marker auf 360°-Fotos als hilfreich ein, auf 360°-Videos waren es nur 61\% und bei den 3D-Modellen waren es 83\%.
...
Personen, die mit einem Wert von 0 bis 6 angeben gelten als Detraktoren, also Personen, die ihren Kollegen davon abraten würden das Produkt zu verwenden. Bei Werten von 7-8 gelten die Personen als Indifferente, die das Produkt nutzen, allerdings nicht positiv Anderen gegenüber davon berichten würden. Die dritte Gruppe sind die Promotoren, die auf die Frage mit 9 oder 10 geantwortet haben. Promotoren werden ihren Kollegen positiv von ihren Erfahrungen mit dem Produkt berichten und dadurch dafür sorgen, dass das Produkt neue Kunden gewinnt und bekannter wird.


% TODO Quelle!

In der Studie zeigte sich, dass 58\% der Teilnehmer Detraktoren wären, 29\% sind indifferent und nur 13\% sind von VRClassroom überzeugt und würden auch ihre Kollegen ermuntern, die Software auszuprobieren. Grafik \ref{fig:survey6} veranschaulicht den NPS der Online-Evaluation von VRClassroom.

\subsubsection{Einschätzung der Zukunft von VR und VRClassroom}
Trotz der insgesamt positiven Bewertungen von VRClassroom in der Studie zeigt Grafik \ref{fig:survey7}, dass nur 42\% glauben, dass Virtual Reality zukünftig eine große Rolle im Schulunterricht spielen wird.
...
Die überwiegende Mehrheit mit 86\% bezeichnet sich selbst als technikaffin, wie Grafik \ref{fig:survey9} zeigt. Allerdings haben nur 46\% der Teilnehmer schon einmal eine VR-Brille ausprobiert.
...
Trotz dieser steigenden Zahlen und positive Prognosen ist davon auszugehen, dass es trotzdem noch eine Weile dauern wird, bis Virtual Reality den Weg in die Schulen finden wird. Denn wie auch in den Ergebnissen der Studie zu sehen sind, glauben nur 42\%, dass Virtual Reality - in welcher Form auch immer - eine große Rolle im Unterricht spielen wird. Außerdem haben selbst von den teilnehmenden Lehrkräften bis dato nur 46\% jemals selber eine VR-Brille ausprobiert. Erst wenn ein übermäßiger Teil der Lehrkräfte selbst Erfahrungen sammeln konnten und genug Unterrichts-geeignetes Material zur Verfügung steht, besteht die Chance, dass Virtual Reality flächendeckend im Unterrichtsgeschehen einbezogen werden wird. VRClassroom soll dabei einen Möglichkeit bieten, mit den Schülerinnen und Schülern erste Erfahrungen mit Virtual Reality als Lernmedium zu sammeln.

Die Studie zeit allerdings auch, dass viele Lehrkräfte interessiert an VR sind, jedoch oft an der fehlenden Infrastruktur scheitern. Damit die Schulen VR-Systeme einsetzten können müssen die Schulnetzwerke verbessert werden und finanzielle Mittel für VR-Headsets bereitgestellt werden. 

Zukünftig ist damit zu rechnen, dass die VR-Headsets weiter im Preis fallen und gleichzeitig mehr Rechenleistung bekommen. Zudem zeigen die Ankündigungen, dass immer mehr Stand-alone Headsets auf den Markt kommen werden.

Weiterhin könnte es sein, dass die Entwicklung der Headsets mit der Zeit wieder weg von Controllern und hin zu anderen Interaktionskonzepten gehen wird. Dabei kämen zum Beispiel das Tracken der Augenbewegungen wie es bei EyeVR passiert oder die Nutzung von Freihandgesten wie es die ClassVR Headsets tun in Frage.
% EyeVR Paper
% ClassVR

Eine weitere Veränderung ist die Wahrnehmung von Virtual Reality. Wie die Autorin von ``5 Major Challenges For The VR Industry'' beschreibt wird momentan VR von viele Menschen noch als Gimmick wahrgenommen. Diese Wahrnehmung wird sich aber zusehends ändern, wenn mehr Anwendungen abseits von Spielen auf den Markt kommen. \cite{Wolwort2018}
...
Zudem war bei Tests vereinzelt zu sehen, dass bei extrem komplexen Modellen die Anzeige abstürzt und ein Neuladen der Schüler-App herbeigeführt wird, sodass das Gerät aus dem Cardboard genommen und die VR-Ansicht neu aktiviert werden muss.
...
Ein weiteres Argument für die aktuelle Implementierung ist das schon zuvor in \ref{subsec:problems} besprochene Problem des Ladens von komplexen Modellen oder hochaufgelösten Videos, also großen Datenmengen. Laden alle Geräte lokal vom Lehrercomputer wird nicht die gesamte Internetverbindung der Schule lahmgelegt und auch die Übertragungsrate ist höher als beim Laden aus dem Internet. 
...
\begin{enumerate}
\item \textbf{Die Bedienung von VRClassroom wirkt einfach und intuitiv.}
\begin{itemize}
...
\item \textbf{Ich glaube, dass meine Schüler 3-dimensionale Sachverhalte mit dem Einsatz von VRClassroom besser verstehen würden als ohne. }
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich glaube ich hätte Spaß an der Nutzung von VRClassroom. }
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich glaube, dass meine Schüler Spaß an der Verwendung von VRClassroom hätten. }
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Das finde ich an VRClassroom nicht gut:} (Freitextfeld)

\item \textbf{Das finde ich an VRClassroom besonders gut:} (Freitextfeld)

\item \textbf{Folgende zusätzliche Funktionen würde ich mir für VRClassroom wünschen:} (Freitextfeld)

\item \textbf{Folgende Inhalte würde ich mir für VRClassroom wünschen:} (Freitextfeld)

\item \textbf{Das müsste sich ändern, damit ich VRClassroom sinnvoll im Unterricht einsetzen kann:} (Freitextfeld)

\item \textbf{Ich finde die Nutzung von 360°-Fotos hilfreich zur Vermittlung des Lehrstoffs.}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich finde die Nutzung von 360°-Videos hilfreich zur Vermittlung des Lehrstoffs.}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich finde die Nutzung von 3D-Modellen hilfreich zur Vermittlung des Lehrstoffs.}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich finde das Setzen von Markern auf 360°-Fotos hilfreich.}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich finde das Setzen von Markern auf 360°-Videos hilfreich.}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich finde das Setzen von Markern auf 3D-Modellen hilfreich.}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich glaube der Einsatz von VRClassroom kann für diese Fächergruppe einen Mehrwert bringen: Naturwissenschaftliche Fächer}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich glaube der Einsatz von VRClassroom kann für diese Fächergruppe einen Mehrwert bringen: Gesellschaftswissenschaftliche Fächer}\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
\item Ich stimme überhaupt nicht zu
...
\item \textbf{Ich glaube der Einsatz von VRClassroom kann für diese Fächergruppe einen Mehrwert bringen: Sprachen}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich glaube der Einsatz von VRClassroom kann für diese Fächergruppe einen Mehrwert bringen: Religion/ Ethik/ Philosophie}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich glaube der Einsatz von VRClassroom kann für diese Fächergruppe einen Mehrwert bringen: Kunst/ Musik}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich glaube der Einsatz von VRClassroom kann für diese Fächergruppe einen Mehrwert bringen: Sport}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Für folgenden Lehrstoff kann ich mir den Einsatz von VRClassroom besonders gut vorstellen:} (Freitextfeld)

\item  \textbf{Ich glaube VRClassroom ist für folgende Klassenstufen geeignet: Grundschule}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich glaube VRClassroom ist für folgende Klassenstufen geeignet: Unterstufe}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich glaube VRClassroom ist für folgende Klassenstufen geeignet: Mittelstufe}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item  \textbf{Ich glaube VRClassroom ist für folgende Klassenstufen geeignet: Oberstufe}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item  \textbf{Ich glaube VRClassroom ist für folgende Klassenstufen geeignet: Erwachsene}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item  \textbf{Ich würde VRClassroom einem Kollegen weiterempfehlen:} (0 = auf keinen Fall, 10 = auf jeden Fall)
\begin{itemize}
\item 0
\item 1
\item 2
...
\item  \textbf{Ich glaube, dass VR (virtual reality) zukünftig eine wichtige Rolle im Unterricht spielen wird.}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item  \textbf{Ich kann mir vorstellen das VRClassroom-System im Unterricht zu verwenden.}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item  \textbf{Wenn VRClassroom marktreif wäre, würde ich es durchschnittlich wie oft pro Klasse nutzen:}
\begin{itemize}
\item Nie
\item 1x im Jahr
\item alle 3 Monate
...
\item \textbf{In folgenden Szenarien (innerhalb und außerhalb des Unterrichts) kann ich mir den Einsatz von VRClassroom vorstellen:} (Freitextfeld)

\item \textbf{Weitere Anmerkungen:} (Freitextfeld)
...
\item  \textbf{Ich bin in dieser Altersgruppe:}
\begin{itemize}
\item unter 30
\item 30-39
\item 40-49
...
\item  \textbf{Ich bin technikaffin.}
\begin{itemize}
\item Ich stimme voll zu
\item Ich stimme etwas zu
\item Ich stimme eher nicht zu
...
\item \textbf{Ich habe schonmal eine VR-Brille benutzt.}
\begin{itemize}
\item nein
\item ja, folgende: (Freitextfeld)
\end{itemize}

\item  \textbf{Ich unterrichte an dieser Schule:}
\begin{itemize}
\item Grundschule
\item Mittelschule
\item Realschule
...
\item \textbf{Diese Medien nutze ich bisher im Unterricht:} (Freitextfeld)
\end{enumerate}
...
Das Github-Repository, in dem der Sourcecode von VRClassroom, die für MacOS, Linux und Windows kompilierten VRClassroom Apps sowie die Thesis sind ist zudem unter \mbox{https://github.com/vronifuchsberger/masterarbeit } erreichbar.
