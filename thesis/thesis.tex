...
Auflösung immer pro Auge! in Tabelle
...
\begin{table}[]
\begin{tabular}{p{0.14\linewidth}|p{0.1\linewidth}|p{0.14\linewidth}|p{0.13\linewidth}|p{0.13\linewidth}|p{0.1\linewidth}|p{0.1\linewidth}}
\textbf{VR-Gerät} & \textbf{DoF} & \textbf{Display} & \textbf{Input} & \textbf{Tracking} & \textbf{Gewicht} & \textbf{Preis} \\ \hline
Oculus Rift &  & t \newline 90Hz \newline 100° & & & 380-470g &  399\$ \\
Playstation VR & & t \newline120Hz \newline 100° & & 610g & &\\
HTC Vive & & t  \newline 90Hz \newline 110° & & & &
\end{tabular}
...
\textbf{VR-Gerät} & \textbf{DoF} & \textbf{Input} & \textbf{Gewicht} & \textbf{Preis} \\ \hline
Google Daydream View &  &  & 261g &  \\
Samsung Gear VR & & & 345g & \\
Google Cardboard & & & 96g &
\end{tabular}
...
Die Rectilinear-Projektion ist anders als die vorigen Projektionen keine zylindrische Projektion, sondern lässt sich verbildlichen indem man eine Kugel auf eine Fläche legt und einen Teil der Kugel vom Mittelpunkt der Kugel auf die Ebene projiziert. Ein einzelnes recitlienares Bild stellt also kein komplettes 360°-Panorama dar. Um ein komplettes Panorama zu erhalten werden dann einfach mehrere rectilineare Projektionen zusammen gesetzt.
...
gibts so nicht. Stattdessen vll Lambert equal-area?
...
kommt aus der Computerspiele-Szene


% Quelle:  https://youtube-eng.googleblog.com/2017/03/improving-vr-videos.html
YT jetzt EAC, Equi-angular
(Heatmap Grafiken aufnehmen?) 
...
Audio: https://facebook.github.io/react-360/docs/audio.html
	3 Soundtypen:
		- environmental audio: nicht spatial, spielt im loop ab
		- sound Effekte: spielen einmal ab (playOneShot())
		- spatial audio: muss erst created werden, dann wird Position übergeben, wenn is3d===true
