...
\end{tabular}
  \caption{Vergleich der Stand-alone VR-Headsets. \cite{Tißler2018}}
  ~\label{tab:headsets2}
\end{table}
...
Da es sich bei der Oculus Go um ein 3DoF-Headset handelt, unterstützt sie kein Positional Tracking, sondern nur orientational Tracking über die eingebauten Sensoren.  \cite{Tißler2018} \cite{VRBoundOculusGo}
