...
Es zwei grundsätzliche Input-Methoden für VR-Headsets, die momentan verwendet werden: Input über Controller mit verschiedenen Buttons und einem ``Raycaster'' in der VR-Welt und das Auslösen von Touch-Events auf dem Display des VR-Headsets. 
