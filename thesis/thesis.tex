...
Vielleicht Display und Frequenz zu einerm Punkt verbinden?
...
Wie in Kapitel XXX (hier Ref reinfügen) beschrieben, gibt es drei grundsätzliche Input-Methoden für VR-Headsets: Input über Controller mit verschiedenen Buttons und einem ``Raycaster'' in der VR-Welt, das Auslösen von Touch-Events auf dem Display und Voice-Input. 
