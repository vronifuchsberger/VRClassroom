...
Die Preise in den Tabllen \ref{tab:headsets1}, \ref{tab:headsets2} und \ref{tab:headsets3} sind in Dollar, wie sie auf dem amerikanischen Markt zu kaufen sind. Darin sind keine Umsatzsteuern enthalten.
...
cubemap, cubestrip 
% Erklärung: https://github.com/naver/egjs-view360/wiki/Supported-Projection-Type
