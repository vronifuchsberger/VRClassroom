...
Besonders gut fanden die Teilnehmer an VRClassroom, dass die Schülerinnen und Schüler immer sehr motiviert werden, wenn sie neue Medien im Unterricht nutzen dürfen und erwarten das auch bei VRClassroom. Außerdem finden sie es sehr gut, dass die Aufmerksamkeit sehr auf die gezeigten Inhalte gelenkt wird und dadurch die Schüler kaum abgelenkt sind. 
...
17. gut für diesen Lehrstoff:
- Architekturmodelle
- Geschichte
eigene Modelle
- Chemie-Experimente, physikalische Kräfte
- Moleküle
geom. körper
Bewebungsabläufe Sport
Kunst
Geographie

23. Szenarien:
- Orte erkunden
- ertser Tag am Arbeitsplatz
- Archtkeutr
- Muesum
- Touristik
- Fahrschule
...
Grafik \ref{fig:survey2} zeigt die Meinung der Befragten zu den verschiedenen Medientypen. Im Vorfeld wurde erwartet, dass besonders 360°-Videos und 3D-Modelle gut bei den Lehrkräften ankommen. Entgegen der Erwartungen schnitten die 360°-Videos deutlich schlechter ab als die anderen beiden Medientypen. 
